export const SHOP_ITEMS = [
  ...
  },
  {
    ...
    filter: 'none',
    spriteOverrides: {
      idle:         { src: '/sprites/uniforms/knight/teaching.png',   blend: false },
      'idle-sleep': { src: '/sprites/uniforms/knight/idle.png',       blend: false },
      happy:        { src: '/sprites/uniforms/knight/oops.png',       blend: false },
      thinking:     { src: '/sprites/uniforms/knight/thinking.png',   blend: false },
      sad:          { src: '/sprites/uniforms/knight/frustrated.png', blend: false },
      surprised:    { src: '/sprites/uniforms/knight/excited.png',    blend: false },
      domain:       { src: '/sprites/uniforms/knight/excited.png',    blend: false },
    },
    imageSrc: null,
