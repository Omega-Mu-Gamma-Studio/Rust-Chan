...
/**
 * rustchan.jsx — Real sprite version
 *
...
const rustchan = () => {
  ...
  useEffect(() => {
    if (rustchanExpression !== 'idle') {
      setDisplayExpression(rustchanExpression);
    ...
    <>
      ...
      {!isDomain && (
        <div className="rustchan-widget">
          ...
          {/* Sprite */}
          <motion.div
            className="rustchan-sprite-wrap"
          ...
          >
            <AnimatePresence mode="wait">
              <motion.img
                ...
                src={sprite.src}
                alt={`Rust-Chan ${displayExpression}`}
                className="rustchan-sprite-img"
                style={sprite.blend ? { mixBlendMode: 'screen' } : {}}
                draggable={false}
