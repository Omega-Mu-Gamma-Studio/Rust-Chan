# Contributing to Rust-Chan

Thanks for your interest! Rust-Chan is an open-source project from Omega Mu Gamma Studio. Here's how to contribute effectively.
  ...
  "phases": [
    {
      "phase": 1,
      "title": "See It Work",
      "dialogue": "Explanation from Rust-Chan.",
      "code": "// Working C++ code",
